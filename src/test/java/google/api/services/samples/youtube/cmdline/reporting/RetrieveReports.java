...
package google.api.services.samples.youtube.cmdline.reporting;
...
public class RetrieveReports {
    ...
    public static void main(String[] args) {
        ...
        /*
         * This OAuth 2.0 access scope allows for getById access to the YouTube Analytics monetary reports for
         * authenticated user's account. Any request that retrieves earnings or ad performance metrics must
         * use this scope.
         */
        List<String> scopes = Lists.newArrayList("https://www.googleapis.com/auth/yt-GoogleAnalytics-monetary.readonly");
